...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lane.validity_period'
        db.add_column(u'lanes_lane', 'validity_period',
                      self.gf('django.db.models.fields.CharField')(default='60*60*24*3', max_length=13),
                      keep_default=False)

        # Adding field 'LaneReservation.approved'
        db.add_column(u'lanes_lanereservation', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'LaneReservation.valid_until'
        db.add_column(u'lanes_lanereservation', 'valid_until',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Lane.validity_period'
        db.delete_column(u'lanes_lane', 'validity_period')

        # Deleting field 'LaneReservation.approved'
        db.delete_column(u'lanes_lanereservation', 'approved')

        # Deleting field 'LaneReservation.valid_until'
        db.delete_column(u'lanes_lanereservation', 'valid_until')
